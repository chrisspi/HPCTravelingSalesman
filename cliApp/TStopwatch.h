// @(#)root/base:$Name:  $:$Id: TTStopwatch.h,v 1.4 2004/04/26 14:41:31 brun Exp $
...
// TTStopwatch                                                           //
//                                                                      //
// TStopwatch class. This class returns the real and cpu time between    //
...
inline double TStopwatch::GetCPUTime()
{
   ...
   times(&cpt);
// 	 cout << gTicks << endl;
// 	 cout << (double)(cpt.tms_utime+cpt.tms_stime) << endl;
